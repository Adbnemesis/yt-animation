...
func _init() -> void:
	...
	# Texture Preloads
	var tex_hood = load("res://assets/brawlers/leon/hood.svg")
	var tex_face_base = load("res://assets/brawlers/leon/face_base.svg")
	var tex_torso = load("res://assets/brawlers/leon/torso_jacket.svg")
	var tex_tail = load("res://assets/brawlers/leon/tail.svg")
	var tex_arm_l = load("res://assets/brawlers/leon/arm_L.svg")
	var tex_arm_r = load("res://assets/brawlers/leon/arm_R.svg")
	var tex_hand_l = load("res://assets/brawlers/leon/hand_L.svg")
	var tex_hand_r = load("res://assets/brawlers/leon/hand_R.svg")
	var tex_leg_l = load("res://assets/brawlers/leon/leg_L.svg")
	var tex_leg_r = load("res://assets/brawlers/leon/leg_R.svg")
	var tex_foot_l = load("res://assets/brawlers/leon/foot_L.svg")
	var tex_foot_r = load("res://assets/brawlers/leon/foot_R.svg")

	var tex_eye_l = load("res://assets/brawlers/leon/eye_L.svg")
	var tex_eye_r = load("res://assets/brawlers/leon/eye_R.svg")
	var tex_pupil_l = load("res://assets/brawlers/leon/pupil_L.svg")
	var tex_pupil_r = load("res://assets/brawlers/leon/pupil_R.svg")
	var tex_brow_l = load("res://assets/brawlers/leon/eyebrow_L.svg")
	var tex_brow_r = load("res://assets/brawlers/leon/eyebrow_R.svg")
	var tex_mouth = load("res://assets/brawlers/leon/mouth_neutral.svg")
